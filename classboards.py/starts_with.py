# Challenge: Given two null-terminated strings in the arguments "string" and 
# "prefix", determine if "string" starts with the "prefix" string. Return true or false.
# Example:
